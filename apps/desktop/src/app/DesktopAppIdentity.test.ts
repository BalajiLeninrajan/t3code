...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/B5 Code.app/Contents/Resources/app.asar",
  isPackaged: true,
  resourcesPath: "/Applications/B5 Code.app/Contents/Resources",
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["B5 Code (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "B5 Code (Alpha)");
