...
// @ts-nocheck -- vendored verbatim; this repo's noUncheckedIndexedAccess is
// stricter than xterm.js's and flags ~90 safe indexed reads. Suppressing keeps
// the file re-copyable from upstream.

import { throwIfFalsy, type ILogService } from './deps';
