...
T3CODE_PORT=13773 \
  "/Applications/B5 Code (Alpha).app/Contents/MacOS/B5 Code (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/B5 Code (Alpha).app"
codesign -d --entitlements :- "/Applications/B5 Code (Alpha).app"
```
